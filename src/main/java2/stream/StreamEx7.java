...
public class StreamEx7 {
    public static void main(String[] args) {
        ...
        Map<Boolean, Optional<Student3>> topScoreBySex = Stream.of(stuArr)
                .collect(partitioningBy(Student3::isMale, maxBy(Comparator.comparingInt(Student3::getScore))));
        ...
        Map<Boolean, Student3> topScoreBySex2 = Stream.of(stuArr)
                .collect(partitioningBy(Student3::isMale,
                        collectingAndThen(
                                maxBy(Comparator.comparingInt(Student3::getScore)), Optional::get
                        )));
        ...
        Map<Boolean, Map<Boolean, List<Student3>>> failedStuBySex = Stream.of(stuArr).collect(partitioningBy(Student3::isMale,
